<?php 	
	...
	//=================================================//
	//Create new columns in 'lists' table
	$q = "SHOW COLUMNS FROM lists WHERE Field = 'unsubscribe_from_list'";
	$r = mysqli_query($mysqli, $q);
	if (mysqli_num_rows($r) == 0)
	{
	    mysqli_query($mysqli, 'ALTER TABLE lists ADD COLUMN unsubscribe_from_list INT (1) DEFAULT \'0\'');
	    mysqli_query($mysqli, 'ALTER TABLE lists ADD COLUMN unsubscribe_list_id INT (11)');
	}
